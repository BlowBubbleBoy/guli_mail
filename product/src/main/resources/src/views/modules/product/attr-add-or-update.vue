<template>
  <el-dialog
    ...
    <el-form-item label="值类型[0-只能单个值，1-允许多个值]" prop="valueType">
      <el-input v-model="dataForm.valueType" placeholder="值类型[0-只能单个值，1-允许多个值]"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          valueType: [
            { required: true, message: '值类型[0-只能单个值，1-允许多个值]不能为空', trigger: 'blur' }
          ],
          enable: [
